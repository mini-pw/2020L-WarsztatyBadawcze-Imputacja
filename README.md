...
W folderze [datasets](/datasets/) stworzymy bazę zbiorów danych dotyczących klasyfikacji binarnej. Dla każdego zbioru danych należy stworzyć folder o nazwie *openml_dataset_id*. W podfolderze powinien znajdować się:
